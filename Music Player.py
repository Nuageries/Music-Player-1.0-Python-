...
def load_music():
    global current_song
    root.directory = filedialog.askdirectory()  # brings a pop-up where we can choose the folder
...
songlist = Listbox(root, bg="black", fg="white",
                   selectbackground="red", width=100, height=15, justify="center")
songlist.pack()  # adds it onto the window
